...
COPY cc_detail
FROM 'C:\Users\hp\OneDrive\Desktop\Credit_Card_Financial_Dashboard - PowerBI for data analytics -Project/cc.add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Users\hp\OneDrive\Desktop\Credit_Card_Financial_Dashboard - PowerBI for data analytics -Project/add.csv' 
DELIMITER ',' 
CSV HEADER;
